...
const TrainingCrud = () => {
  ...
  const setData = () => {
    ...
    axios
      .post("http://localhost:1000/api/training/adddata", formdata)
      .then((res) => {
        console.log(res);
        getData();
      })
  ...
  const getData = () => {
    axios
      .get("http://localhost:1000/api/training/getdata")
      .then((res) => {
        arr = res.data.data;
        setarr([...arr]);
      })
  ...
  const editFunction = (id) => {
    axios
      .get(
        "http://localhost:1000/api/training/getdata?id=" +
          id
      )
      .then((res) => {
        obj = res.data.data;
  ...
  const updateapi = () => {
    obj.id = obj._id;
    axios
      .post("http://localhost:1000/api/training/adddata", obj)
      .then((res) => getData())
      .catch((err) => console.log(err));
  };
